...
function Account() {
    ...
    const { patchWithToken, user, token, putWithToken, logout } = useFetch();
    ...
    return (
      <>
        ...
        <section id="formWrapper" className="w-full bg-zinc-400">

            <h1 className="font-serif text-5xl text-center px-8 pt-10 text-white font-extrabold mb-8 lg:text-left">
                Account Settings
            </h1>

            <div className="flex items-center flex-col gap-5 justify-center lg:items-start lg:flex-row lg:gap-0">
                <div className="flex items-center px-8 justify-center">
                    <div className="div flex flex-row gap-3 bg-white max-w-lg w-full p-3 rounded-md shadow-md lg:flex-col">
                        <button className={`text-lg font-medium px-5 py-3 ${formShown === 0 ? "bg-primary text-white shadow-md" : ""}`}
                            onClick={() => setFormShown(() => 0)}>Edit details</button>
                        <button className={`text-lg font-medium px-5 py-3  whitespace-nowrap ${formShown === 1 ? "bg-primary text-white shadow-md" : ""}`}
                            onClick={() => setFormShown(() => 1)}>Change password</button>
                    </div>
                </div>
                <div className="container mx-auto pb-10 flex flex-col items-center lg:items-start lg:flex-row">
                    <article className="w-full flex pb-10 justify-center lg:justify-start">
